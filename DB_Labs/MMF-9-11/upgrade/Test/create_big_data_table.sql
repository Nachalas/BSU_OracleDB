...
INSERT INTO DATA_TABLE (First_name, Last_name, Nickname, Email, Playlist_name, Playlist_Type, Music_Type, Composition_name, Length, Owner_First_name, Owner_Last_name, Owner_nickname, Liked, Composition_Likes, Listen)
...
INSERT INTO DATA_TABLE (First_name, Last_name, Nickname, Email, Playlist_name, Playlist_Type, Music_Type, Composition_name, Length, Owner_First_name, Owner_Last_name, Owner_nickname, Liked, Composition_Likes, Listen, comment_track, current_listening, stopped_time)
...
INSERT INTO DATA_TABLE (First_name, Last_name, Nickname, Email, Playlist_name, Playlist_Type, Music_Type, Composition_name, Length, Owner_First_name, Owner_Last_name, Owner_nickname, Liked, Composition_Likes, Listen)
VALUES 				   ('Елизавета', 'Рапинчук', 'Bug', 'Circle_Bug@gmail.com', 'Bamboo', 'User', 'Electronic', 'James Blake - Air & Lack Thereof', '4.09', 'Hélder', 'Leal', 'Hotshot', 'no', 4455, 1433);
INSERT INTO DATA_TABLE (First_name, Last_name, Nickname, Email, Playlist_name, Playlist_Type, Music_Type, Composition_name, Length, Owner_First_name, Owner_Last_name, Owner_nickname, Liked, Composition_Likes, Listen)
